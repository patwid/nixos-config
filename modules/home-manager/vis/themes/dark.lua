...
lexers.STYLE_DEFAULT = 'back:black,fore:'..white1
...
lexers.STYLE_LINENUMBER = 'fore:'..black2
...
lexers.STYLE_SELECTION = 'back:'..black1..',bold'
lexers.STYLE_STATUS = 'back:'..black1..',fore:'..white1
